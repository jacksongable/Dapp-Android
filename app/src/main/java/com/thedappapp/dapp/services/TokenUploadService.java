...
public class TokenUploadService extends IntentService {
    ...
    private void handleRegisterToken() {
        ...
        String token = preferences.getString("device_token", "null");
        ...
        if (token.equals("null")) {
            ...
            FirebaseDatabase.getInstance().getReference("users").child(App.getApp().me().getUid()).child("device_token").setValue(token);
